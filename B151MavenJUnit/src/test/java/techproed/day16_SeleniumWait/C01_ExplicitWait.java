...
public class C01_ExplicitWait extends TestBase {
    ...
    SELENIUM WAIT:
         ...
         Bunu Testbaseye en başlata yazmıştık.
    ...
    public void test01() {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));//1.YOL-->max.20 saniye belirttik
        wait.until(ExpectedConditions.visibilityOf(helloWorldText));
    ...
    @Test
    public void test02() { //AYNI SORU 2. YOL
        //https://the-internet.herokuapp.com/dynamic_loading/1
        driver.get("https://the-internet.herokuapp.com/dynamic_loading/1");
        ...
        //Hello World! Yazının sitede oldugunu test et// Bu Yol en temizi !!!!!!!
        WebElement helloWorldText = new WebDriverWait(driver,Duration.ofSeconds(20)).//2. YOL
                until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h4)[2]")));
//(//h4)[2] yukarı çözümde burayı bir web elentine locate ettik!!!!!! WebElement helloWorldText = driver.findElement(By.xpath("(//h4)[2]"));
        Assert.assertEquals("Hello World!",helloWorldText.getText());
    }

    @Test
    public void test03() {// AYNI SORU 3. YOL
        //https://the-internet.herokuapp.com/dynami_loading/1
        driver.get("https://the-internet.herokuapp.com/dynamic_loading/1");
        ...
        //Hello World! Yazının sitede oldugunu test et
        new WebDriverWait(driver,Duration.ofSeconds(20)). // 3.YOL
                until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h4)[2]")));
                                                                                     //Hello world' ün locate i (//h4)[2]
