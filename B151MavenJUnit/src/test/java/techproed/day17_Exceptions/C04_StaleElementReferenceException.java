...
public class C04_StaleElementReferenceException extends TestBase {
    ...
    public void test01() {
        ...
        tekrar locate almalıyız.Aşağıda tekrar locate aldık o yüzden.
         */
    ...
    public void test04() {
        ...
        List<WebElement> urunler = driver.findElements(By.xpath("//h2//a")); //findElementssssss!!!! diyoruz
        //Çünkü o sayfadaki tüm iphone ları listeye ekledik.
