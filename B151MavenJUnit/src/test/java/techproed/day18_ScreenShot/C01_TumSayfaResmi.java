...
public class C01_TumSayfaResmi extends TestBase {
    ...
    public void test01() throws IOException {
         ...
         */
        String dosyaYolu = "src/test/java/techproed/TumSayfaResmi/screenShot3.jpeg";//screenShot3.jpeg dosya adıdır, öncesi dosya doyu
        TakesScreenshot ts = (TakesScreenshot) driver;
        FileUtils.copyFile(ts.getScreenshotAs(OutputType.FILE),new File(dosyaYolu));//dosya yolunu değişkene atamadanda direkt
        //dosya yolu+doyda adı File() içine yazabiliriz.Aşağıdaki örnekte öyle yapacağız.
    ...
    public void test02() throws IOException {
        ...
        //Ve ekran görüntüsünü alalım
        TakesScreenshot ts = (TakesScreenshot) driver; //Dosya yolunu değişkene atamadık dosya yolunu direkt File ın içine yazdık
    ...
    public void test04() throws IOException {
        ...
        String tarih = new SimpleDateFormat("_hh_mm_ss_ddMMyyyy").format(new Date());
        String dosyaYolu = "src/test/java/techproed/TumSayfaResmi/screenShot" + tarih + ".jpeg";
        //Screenshot/screenShot"+ tarih + ".jpeg" dosya yolunu (javanın içinde yapmak zorunda değiliz) eğer böyle yaparsak
        //src dosyasının nın üstünde Screenshot dosyası açılır!!!!!!!!!!!!!!!!!!!!
        TakesScreenshot ts = (TakesScreenshot) driver;
