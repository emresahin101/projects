...
public class C01_ExtentReport extends TestBase {
    ...
    @Test
    public void test01() {
        extentReports = new ExtentReports();// Yukarıda initial yapıldı
        String tarih = new SimpleDateFormat("_hh_mm_ss_ddMMyyyy").format(new Date());
        String dosyaYolu = "testOutput/extentReports/extentReport"+tarih+".html";
        extentHtmlReporter = new ExtentHtmlReporter(dosyaYolu);// Yukarıda initialize yapıldı
        ...
        extentReports.setSystemInfo("Browser","Chrome");//Bunların içine 2 li string yazılıyor
