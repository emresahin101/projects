...
public abstract class TestBase {
    ...
    public void extentReport(String browser, String reportName) {
        extentReports = new ExtentReports(); //Bunların initialize si TestBase in en yukarısında
        String tarih = new SimpleDateFormat("_hh_mm_ss_ddMMyyyy").format(new Date());
        String dosyaYolu = "testOutput/extentReports/extentReport" + tarih + ".html";
        extentHtmlReporter = new ExtentHtmlReporter(dosyaYolu);//Bunların initialize si TestBase in en yukarısı
