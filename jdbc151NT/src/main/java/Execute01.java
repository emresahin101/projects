...
public class Execute01 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //3. Adım: Statement oluştur.Statement statement = connection.createStatement();
        Statement statement = connection.createStatement();

        //4. Adım: Query çalıştır
        /*
        execute() methodu DDL(create, drop, alter table) ve DQL(select) ile kullanılır
        1) Eğer execute() methodu DDL ile kullanılırsa o işlem yapılır ama geriye veri çağırmadığı için  "false" döner.
        Çünkü DDL ile data çağrılmaz
